...
namespace AlphaBehavioursAndEvents
{
    ...
    public class IncidentWorker_DunealiskClutchMother : IncidentWorker
    {
        ...
        protected override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            IntVec3 intVec;
            return map.mapTemperature.SeasonAndOutdoorTemperatureAcceptableFor(ThingDef.Named("AA_DunealiskClutchMother")) && this.TryFindEntryCell(map, out intVec) && LoadedModManager.GetMod<AlphaAnimals_Mod>().GetSettings<AlphaAnimals_Settings>().flagSpiderClutchMothers;
        }
