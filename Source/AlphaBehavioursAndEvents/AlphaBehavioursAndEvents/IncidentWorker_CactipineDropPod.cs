...
namespace AlphaBehavioursAndEvents
{
    public class IncidentWorker_CactipineDropPod : IncidentWorker
    {
        ...
        protected override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            return this.TryFindAnimalKind(map.Tile, out pawnKindDef) && LoadedModManager.GetMod<AlphaAnimalsEvents_Mod>().GetSettings<AlphaAnimalsEvents_Settings>().flagCactipineDroppods;
        }
