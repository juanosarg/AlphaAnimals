...
namespace AlphaBehavioursAndEvents
{
    public class IncidentWorker_Aerofleets : IncidentWorker
    {
        protected override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            IntVec3 intVec;
            return !map.gameConditionManager.ConditionIsActive(GameConditionDefOf.ToxicFallout) && map.mapTemperature.SeasonAndOutdoorTemperatureAcceptableFor(ThingDef.Named("AA_Aerofleet")) && this.TryFindEntryCell(map, out intVec);
        }
