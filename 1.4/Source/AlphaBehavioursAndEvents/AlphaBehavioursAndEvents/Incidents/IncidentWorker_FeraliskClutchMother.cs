...
namespace AlphaBehavioursAndEvents
{
    ...
    public class IncidentWorker_FeraliskClutchMother : IncidentWorker
    {
        ...
        protected override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            IntVec3 intVec;
            return map.mapTemperature.SeasonAndOutdoorTemperatureAcceptableFor(InternalDefOf.AA_FeraliskClutchMother.race) && this.TryFindEntryCell(map, out intVec) && AlphaAnimalsEvents_Mod.settings.flagSpiderClutchMothers;
        }
        ...
        {
            Map map = (Map)parms.target;
            PawnKindDef pawnKindDef = InternalDefOf.AA_FeraliskClutchMother;
            IntVec3 intVec;
