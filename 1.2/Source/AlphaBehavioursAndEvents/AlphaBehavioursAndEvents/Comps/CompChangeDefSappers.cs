...
{
    public class CompChangeDefSappers : ThingComp
    {




        public CompProperties_ChangeDefSappers Props
        {
            get
            {
                return (CompProperties_ChangeDefSappers)this.props;
            }
        }
        ...
        {
            base.CompTick();
            if (!AlphaAnimalsEvents_Settings.flagAlphaMechanoidsSappers) {
                if (parent.Map != null)
                {
