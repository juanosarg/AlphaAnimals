    ...
    public class CompChangeDef : ThingComp
    {
        ...
        public override void CompTick()
        {
            ...
            if (!AlphaAnimalsEvents_Settings.flagAlphaMechanoids) {
                ...
                {
                    PawnGenerationRequest request = new PawnGenerationRequest(PawnKindDef.Named(Props.defToChangeTo), Find.FactionManager.FirstFactionOfDef(Props.factionToChangeTo), PawnGenerationContext.NonPlayer, -1, false, false, false, false, true, false, 1f, false, true, true, false, false);
