    ...
    public class DeathActionWorker_ExplodeAndSpawnEggs : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse)
        {
            if (corpse.Map != null) {
                ...
                GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, DamageDefOf.Flame, corpse.InnerPawn, -1, -1, null, null, null, null, null, 0f, 1, false, null, 0f, 1, 0, false, null, ignoredThings);
