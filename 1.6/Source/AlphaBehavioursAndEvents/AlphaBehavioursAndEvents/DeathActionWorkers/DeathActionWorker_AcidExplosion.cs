...
namespace AlphaBehavioursAndEvents
{
    public class DeathActionWorker_AcidExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse, Lord previousLord )
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, InternalDefOf.AA_AcidSpit, corpse.InnerPawn, 10, -1, InternalDefOf.AA_GooPop, null, null, null, InternalDefOf.AA_Filth_Slime, 1f, 1,null, null,255,false, null, 0f, 1);
        }
