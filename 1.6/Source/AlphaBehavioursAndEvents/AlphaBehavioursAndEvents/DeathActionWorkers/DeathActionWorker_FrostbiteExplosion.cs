...
namespace AlphaBehavioursAndEvents
{
    public class DeathActionWorker_FrostbiteExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse, Lord previousLord)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, DamageDefOf.Frostbite, corpse.InnerPawn, 10, -1, InternalDefOf.AA_IceCrash, null, null, null, InternalDefOf.AA_FrostPuff, 1f, 1, null, null, 255,false, null, 0f, 1);
        }
