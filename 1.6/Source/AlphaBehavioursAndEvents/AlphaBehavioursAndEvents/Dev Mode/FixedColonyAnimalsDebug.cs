...
namespace AlphaBehavioursAndEvents
{
    public static class FixedColonyAnimalsDebug
    {
        ...
        [DebugAction("Autotests", "Make colony (animals, fixed)", false, false, false, false, false, allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        public static void MakeColony(params ColonyMakerFlag[] flags)
        {
            ...
            if (flags.Contains(ColonyMakerFlag.Animals))
            {
                                                    ...
                                                    select k)
                {
                    ...
                    deadpawn.Kill(null);
                    CompRottable compRottable = ((Corpse)intVec.GetThingList(Find.CurrentMap).FirstOrFallback((Thing t) => t is Corpse))?.TryGetComp<CompRottable>();
