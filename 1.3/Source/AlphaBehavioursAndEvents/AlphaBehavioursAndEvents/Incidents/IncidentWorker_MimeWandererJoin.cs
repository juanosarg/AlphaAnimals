...
namespace AlphaBehavioursAndEvents
{
    public class IncidentWorker_MimeWandererJoin : IncidentWorker
    {
        ...
        public virtual Pawn GeneratePawn()
        {
            ...
            return PawnGenerator.GeneratePawn(new PawnGenerationRequest(this.def.pawnKind, Faction.OfPlayer, PawnGenerationContext.NonPlayer, -1, true, false, false, false, true, this.def.pawnMustBeCapableOfViolence, 20f, false, true, true, true, false, false, false, false, 0f,0f, null, 1f, null, null, null, null, null, null, null, fixedGender, null, null, null, null));
        }
