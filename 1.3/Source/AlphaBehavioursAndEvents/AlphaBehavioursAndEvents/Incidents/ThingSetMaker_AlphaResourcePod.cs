...
namespace AlphaBehavioursAndEvents
{
    ...
    public class ThingSetMaker_AlphaResourcePod : ThingSetMaker
    {
        protected override void Generate(ThingSetMakerParams parms, List<Thing> outThings)
        {
            ...
            PawnGenerationRequest request = new PawnGenerationRequest(list.RandomElement<PawnKindDef>(), null, PawnGenerationContext.NonPlayer, -1, false, false, false, false, true, false, 1f, false, true, true, true, false, false, false, false, 0f,0f, null, 1f, null, null, null, null, null, null, null, null, null, null, null, null);
