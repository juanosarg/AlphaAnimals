                ...
                if (tickerInterval >= tickerMax)
                {
                    ...
                    if (hashSet != null)
                    {
                        foreach (Thing current in hashSet)
                        {
                            ...
                            if (flag)
                            {
                               if (plant.IsTree && (current.def.defName != "GU_AlienTree")&& (current.def.defName != "AA_AlienTree"))
                               {
                                    ...
                                    &&(current.def.defName != "AA_AlienGrass") && (current.def.defName != "AA_RedLeaves") && (current.def.defName != "AA_RedPlantsTall")
                                    )
                                {
