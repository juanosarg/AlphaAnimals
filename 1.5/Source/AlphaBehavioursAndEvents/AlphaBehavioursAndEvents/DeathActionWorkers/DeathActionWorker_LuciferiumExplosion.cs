...
namespace AlphaBehavioursAndEvents
{
    public class DeathActionWorker_LuciferiumExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse, Lord previousLord)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, InternalDefOf.AA_LuciferiumExplosion, corpse.InnerPawn, 30, -1, InternalDefOf.AA_GooPop, null, null, null, InternalDefOf.AA_Filth_RedSlime, 1f, 1, null, false, null, 0f, 1);
        }
