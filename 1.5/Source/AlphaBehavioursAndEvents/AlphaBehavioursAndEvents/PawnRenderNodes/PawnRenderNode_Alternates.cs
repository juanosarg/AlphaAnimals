...
{
    public class PawnRenderNode_Alternates : PawnRenderNode_AnimalPart
    {
        public PawnRenderNode_Alternates(Pawn pawn, PawnRenderNodeProperties props, PawnRenderTree tree)
        ...
        public override Graphic GraphicFor(Pawn pawn)
        {
            ...
            if (AlphaAnimalsEvents_Mod.settings.alternatePokemonGraphics)
            {
                ...
                Graphic graphic = GraphicDatabase.Get<Graphic_Multi>("Things/Pawn/Animal_Alternate/"+pawn.def.defName+"/"+ pawn.def.defName, OGgraphic.Shader, OGgraphic.drawSize, OGgraphic.color);
