...
namespace AlphaBehavioursAndEvents
{
    internal class CompCocoon : ThingComp
    {
        ...
        public override void CompTick()
        {
            ...
            {
                CellFinder.TryFindRandomReachableCellNearPosition(this.parent.Position, this.parent.Position, parent.Map, 4, TraverseParms.For(TraverseMode.NoPassClosedDoors, Danger.Deadly, false), null, null, out IntVec3 c);
                FilthMaker.TryMakeFilth(c, parent.Map, ThingDefOf.Filth_Slime);
                InternalDefOf.Hive_Spawn.PlayOneShot(new TargetInfo(parent.Position, parent.Map));
