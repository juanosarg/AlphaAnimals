...
namespace AlphaBehavioursAndEvents
{
    public class Building_Overgrown_DropPod : Building
    {
        ...
        {
            if (!c.Standable(map) || c.Fogged(map) || map.fertilityGrid.FertilityAt(c) < ThingDef.Named("AA_Heat_Ambrosia").plant.fertilityMin || !c.GetRoom(map, RegionType.Set_Passable).PsychologicallyOutdoors || c.GetEdifice(map) != null)
            {
                return false;
            }
